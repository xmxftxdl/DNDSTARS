 ...
 * only shows the authoritative result card. The dead CSS-3D / cannon-es
 * animation layer (Die6 / PolyDie / Die20 / DiceBoxRollDice and the four
 * always-false branches) was removed in T-P2-400.
 */
